class Person:
    def init(self, name, age, gender, height, hobby):
...
human_1 = Person(name = 'Vera', age = 20, gender = 'female',
                height = 1.67, hobby = True)
human_2 = Person(name = 'Joe', age = 22, gender = 'male',
                height = 1.85, hobby = False)
